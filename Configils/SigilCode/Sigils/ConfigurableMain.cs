...
{
    public class ConfigurableMain : ActivatedAbilityBehaviour, IOnBellRung, IOnOtherCardAddedToHand, IOnCardAssignedToSlotContext, IOnCardDealtDamageDirectly
    {
        ...
        public void Initialize(SigilData abilityData, Ability ability)
        {
            ...
            _logic = new ConfigilAbilityLogic(this, abilityData);
        }
