...
using Deck = JSONLoader3.Cores.JSONLoaderV2Support.Schemas.Deck;
        ...
        foreach ((int depth, string propertyName, string propertyValue) in JSONStarterDeck)
        {
            if (propertyName == "decks" && depth == 1)
            {
                ...
                foreach (string deck in deckObjects)
                {
                    ...
                    {
                        if (propertyName2 == "fieldsToEdit" && depth2 == 2)
                        {
                        ...
                        if (propertyName2 == "cards" && depth2 == 2)
                        {
                    ...
                    DeckDataObject deckDataObject = new DeckDataObject(fieldsToEdit, name, modPrefix, title, cards,
                        iconTexture, unlockLevel, file, pluginName);
