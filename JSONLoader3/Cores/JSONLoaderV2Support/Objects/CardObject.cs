...
public class CardObject
{
    ...
    public CardInfo ConvertCardObjectToCardInfo()
    {
        ...
        {
            CardInfo infoTemp = CardManager.BaseGameCards.FirstOrDefault(x => x.name == name.Replace(modPrefix + "_", ""));
            if (infoTemp == null)
            {
                infoTemp = CardManager.NewCards.FirstOrDefault(x => x.name == name.Replace(modPrefix + "_", ""));
            }
            if (infoTemp != null)
            {
                info = infoTemp;
