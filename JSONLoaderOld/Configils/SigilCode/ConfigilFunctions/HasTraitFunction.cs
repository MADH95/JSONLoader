...
{
    internal static class HasTraitFunction
    {
        internal static void Evaluate(FunctionArgs functionArgs)
        {
            ...
            {
                throw new FormatException($"HasTrait() requires 2 parameters.");
            }
            ...
            Trait trait = (Trait)parameters[1];
            functionArgs.Result = card.Info.HasTrait(trait);
        }
    }
}
